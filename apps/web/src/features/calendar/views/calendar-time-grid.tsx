...
export function CalendarTimeGrid(props: GridProps) {
  ...
  return <div data-calendar-scroll ref={props.scrollRef} className="min-h-0 flex-1 overflow-auto"><div className="min-w-[560px]">
