...
export const DEFAULT_CALENDAR_BUFFERS: CalendarBuffers = { before: 28, after: 28, monthBefore: 56, monthAfter: 56 };
...
export function normalizeCalendarBuffers(value: unknown): CalendarBuffers {
