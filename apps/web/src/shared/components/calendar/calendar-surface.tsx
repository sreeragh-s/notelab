...
export function CalendarSurface(props: CalendarSurfaceProps) {
 ...
 const timeline = useTimelineWindow(props);
  ...
  const content = surfaceView({ view, loadingMessage, timeline, date, props, eventsByDay, preferences, onChange, writable, card, day, create, zoneControls, days, onSelect, renderItem });
