...
async function processMailIndexTask(
  env: RuntimeEnv,
  resourceId: string,
): Promise<BackgroundTaskResult> {
...
async function processDatabaseRealtimeTask(
  env: RuntimeEnv,
  resourceId: string,
) {
...
async function processNavigationRealtimeTask(
  env: RuntimeEnv,
  resourceId: string,
) {
