...
[Agent modules](../../../apps/server/src/features/ai/agents) own profiles/revisions, conversations, durable runs and execution. [Jobs](../../../apps/server/src/features/ai/jobs) implement queued AI work. [Background composition](../../../apps/server/src/app/background/processor.ts) dispatches agent.run and ai.job tasks to those implementations.
