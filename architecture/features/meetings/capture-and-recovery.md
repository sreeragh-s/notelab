...
Use existing [state tests](../../../apps/server/src/features/meetings/meeting-state.test.ts), transcription tests and native tests for device/transport failures. [Meeting block guide](../../../docs/meetings/meeting-block.md) explains the editor-facing integration.
