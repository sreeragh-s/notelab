...
Key routes integrate Better Auth key management with request authentication. Header parsing recognizes the existing nl_ key prefix; key metadata can scope a caller to a workspace.
