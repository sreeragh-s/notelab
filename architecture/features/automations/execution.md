...
[Run engine](../../../apps/server/src/features/databases/automations/run-engine.ts) claims durable work and renews its lease under the worker identity. [Execution context](../../../apps/server/src/features/databases/automations/execution-context.ts) loads the pinned revision and resources; [action executor](../../../apps/server/src/features/databases/automations/action-executor.ts) selects the concrete action implementation.
