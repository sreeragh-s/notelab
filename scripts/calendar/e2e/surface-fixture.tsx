...
const preferences: CalendarDisplayPreferences = { timeZone: "Asia/Kolkata", timeFormat: "24", weekStartsOn: 1, showWeekends: true, showWeekNumbers: false, secondaryTimeZones: [] };
